...
_INSTALL_I18N = {
    "en": {
        ...
        "install_done": "✅",
        "install_done_with_errors": "Install finished with errors. Manual steps were sent.",
        ...
        "q_vps_desc": "VPS is a rented server in a datacenter (not a home PC) and usually has a public IP.",
        "q_public_title": "Do you have a public (external) IP?",
        "q_public_desc": "External IP is what you see on sites like 2ip/ifconfig. If it starts with 192.168/10/172.16-31, it's local.",
        "q_device_title": "Is your userbot on the same device?",
        "q_device_desc": "If not, it will work only when both devices are on the same Wi-Fi/LAN.",
        "btn_yes": "✅ Yes",
        "btn_no": "❌ No",
    ...
    "ru": {
        ...
        "install_done": "✅",
        "install_done_with_errors": "Установка завершена с ошибками. Шаги отправлены.",
        ...
        "q_vps_desc": "VPS — это арендуемый сервер в дата-центре (не домашний ПК), обычно с внешним IP.",
        "q_public_title": "У вас есть внешний IP?",
        "q_public_desc": "Внешний IP видно на сайтах 2ip/ifconfig. Если адрес 192.168/10/172.16-31 - это локальный.",
        "q_device_title": "Юзербот на этом же устройстве?",
        "q_device_desc": "Если нет - работать будет только когда оба устройства в одной Wi-Fi/LAN сети.",
        "btn_yes": "✅ Да",
        "btn_no": "❌ Нет",
    ...
    "be": {
        ...
        "install_done": "✅",
        "install_done_with_errors": "Устаноўка з памылкамі. Крокі адпраўлены.",
        ...
        "q_vps_title": "У вас VPS?",
        "q_vps_desc": "VPS — арэндаваны сервер у дата-цэнтры (не хатні ПК), звычайна з вонкавым IP.",
        "q_public_title": "Ёсць знешні IP?",
        "q_public_desc": "Знешні IP бачны на 2ip/ifconfig. Калі 192.168/10/172.16-31 - гэта лакальны.",
        "q_device_title": "Юзербот на гэтым жа прыладзе?",
        "q_device_desc": "Калі не - будзе працаваць толькі калі абедзве прылады ў адной Wi-Fi/LAN сетцы.",
        "btn_yes": "✅ Так",
        "btn_no": "❌ Не",
    ...
    "uk": {
        ...
        "install_done": "✅",
        "install_done_with_errors": "Встановлення з помилками. Кроки надіслано.",
        ...
        "q_vps_title": "У вас VPS?",
        "q_vps_desc": "VPS — орендований сервер у дата-центрі (не домашній ПК), зазвичай із зовнішнім IP.",
        "q_public_title": "Є зовнішній IP?",
        "q_public_desc": "Зовнішній IP видно на 2ip/ifconfig. Якщо 192.168/10/172.16-31 - це локальний.",
        "q_device_title": "Юзербот на цьому ж пристрої?",
        "q_device_desc": "Якщо ні - працюватиме лише коли обидва пристрої в одній Wi-Fi/LAN мережі.",
        "btn_yes": "✅ Так",
        "btn_no": "❌ Ні",
    ...
    "kk": {
        ...
        "install_done": "✅",
        "install_done_with_errors": "Қателермен аяқталды. Қадамдар жіберілді.",
        ...
        "q_vps_desc": "VPS — дата-орталықтағы жалға алынған сервер (үйдегі ПК емес), көбіне сыртқы IP болады.",
        "q_public_title": "Сыртқы IP бар ма?",
        "q_public_desc": "Сыртқы IP 2ip/ifconfig сайттарында көрінеді. 192.168/10/172.16-31 болса - бұл жергілікті.",
        "q_device_title": "Юзербот осы құрылғыда ма?",
        "q_device_desc": "Егер жоқ - тек екі құрылғы бір Wi-Fi/LAN желісінде болғанда жұмыс істейді.",
        "btn_yes": "✅ Иә",
        "btn_no": "❌ Жоқ",
    ...
    "fr": {
        ...
        "install_done": "✅",
        "install_done_with_errors": "Installation avec erreurs. Étapes envoyées.",
        ...
        "q_vps_desc": "Un VPS est un serveur loué en datacenter (pas un PC à la maison), souvent avec une IP publique.",
        "q_public_title": "Avez-vous une IP publique ?",
        "q_public_desc": "L'IP publique est celle de 2ip/ifconfig. Si 192.168/10/172.16-31, c'est local.",
        "q_device_title": "Le userbot est sur le même appareil ?",
        "q_device_desc": "Sinon, ça marche seulement si les deux appareils sont sur le même Wi-Fi/LAN.",
        "btn_yes": "✅ Oui",
        "btn_no": "❌ Non",
    ...
    "ja": {
        ...
        "install_done": "✅",
        "install_done_with_errors": "エラーあり。手順を送信しました。",
        ...
        "q_vps_title": "VPSですか？",
        "q_vps_desc": "VPSはデータセンターのレンタルサーバー（自宅PCではない）で、外部IPを持つことが多いです。",
        "q_public_title": "外部IPはありますか？",
        "q_public_desc": "外部IPは2ip/ifconfigに表示。192.168/10/172.16-31ならローカルです。",
        "q_device_title": "ユーザーボットは同じ端末？",
        "q_device_desc": "違う端末なら、同じWi-Fi/LAN内でのみ動作します。",
        "btn_yes": "✅ はい",
        "btn_no": "❌ いいえ",
    ...
    "zh": {
        ...
        "install_done": "✅",
        "install_done_with_errors": "安装有错误。步骤已发送。",
        ...
        "q_vps_desc": "VPS是机房租用服务器（不是家用电脑），通常有公网IP。",
        "q_public_title": "有公网IP吗？",
        "q_public_desc": "公网IP可在2ip/ifconfig看到。若是192.168/10/172.16-31就是内网。",
        "q_device_title": "用户机器人在同一设备吗？",
        "q_device_desc": "否则仅在同一Wi-Fi/LAN内可用。",
        "btn_yes": "✅ 是",
        "btn_no": "❌ 否",
    ...
    "ko": {
        ...
        "install_done": "✅",
        "install_done_with_errors": "오류 포함. 단계 전송됨.",
        ...
        "q_vps_title": "VPS인가요?",
        "q_vps_desc": "VPS는 데이터센터에 있는 임대 서버(집 PC 아님)이며 보통 외부 IP가 있습니다.",
        "q_public_title": "외부 IP가 있나요?",
        "q_public_desc": "외부 IP는 2ip/ifconfig에 표시됩니다. 192.168/10/172.16-31이면 로컬입니다.",
        "q_device_title": "유저봇이 같은 기기인가요?",
        "q_device_desc": "다른 기기라면 같은 Wi-Fi/LAN에서만 동작합니다.",
        "btn_yes": "✅ 예",
        "btn_no": "❌ 아니오",
    ...
    "kp": {
        ...
        "install_error": "설치 실패. 로그: `.etg log`",
        "install_done": "✅",
        "install_done_with_errors": "오류 있음. 단계 전송됨.",
        "install_cancel": "설치 취소됨.",
        "port_prompt": "포트 입력: `.etg 8955`",
        "port_invalid": "포트 1-65535. 예: `.etg 8955`",
        "port_busy": "{port} 포트 사용 중: {error}",
    ...
    "pir_ru": {
        ...
        "install_done": "✅",
        "install_done_with_errors": "С косяками. Шаги отправлены.",
        ...
        "q_vps_desc": "VPS — арендованный сервер в дата-центре, не домашка; обычно с внешним IP.",
        "q_public_title": "Есть внешний IP, моряк?",
        "q_public_desc": "Внешний IP видно на 2ip/ifconfig. 192.168/10/172.16-31 - это локалка.",
        "q_device_title": "Юзербот на этом же корыте?",
        "q_device_desc": "Если не на этом устройстве - работает только в одной Wi-Fi/LAN сети.",
        "btn_yes": "✅ Да, капитан",
        "btn_no": "❌ Нет, капитан",
        "btn_same_device": "✅ На этом",
        "btn_other_device": "📡 На другом",
    ...
    "pir_en": {
        ...
        "install_done": "✅",
        "install_done_with_errors": "With errors. Steps sent.",
        ...
        "q_vps_desc": "VPS be a rented datacenter box (not a home PC), usually with a public IP.",
        "q_public_title": "Got a public IP?",
        "q_public_desc": "Public IP be what 2ip/ifconfig shows. If 192.168/10/172.16-31 - it's local.",
        "q_device_title": "Userbot on the same ship?",
        "q_device_desc": "If not same device, only works when both be on the same Wi-Fi/LAN.",
        "btn_yes": "✅ Aye",
        "btn_no": "❌ Nay",
    ...
    "meme": {
        ...
        "install_done": "✅",
        "install_done_with_errors": "С ошибками. Шаги отправил.",
        "install_cancel": "Отмена.",
        ...
        "check_summary": "Чек порта: внешний {ext} / локальный {loc}",
        "q_vps_title": "Это VPS?",
        "q_vps_desc": "VPS = арендованный сервер в дата-центре, не домашний комп, обычно с внешним IP.",
        "q_public_title": "Есть внешний IP?",
        "q_public_desc": "Внешний IP виден на 2ip/ifconfig. 192.168/10/172.16-31 - это локалка.",
        "q_device_title": "Юзербот на этом устройстве?",
        "q_device_desc": "Если не на этом девайсе - работает только в одной Wi-Fi/LAN сети.",
        "btn_yes": "✅ Да",
        "btn_no": "❌ Нет",
...
class EtgBridgeMod(loader.Module):
    ...
    async def client_ready(self):
        self._patch_unregister_commands()
    ...
    @staticmethod
    def _patch_unregister_commands() -> None:
        try:
            mods_cls = loader.Modules
        except Exception:
            return
        if getattr(mods_cls, "_etg_safe_unreg", False):
            return

        def safe_unregister(self_mods, instance: "loader.Module", purpose: str):
            for name, cmd in self_mods.commands.copy().items():
                if not hasattr(cmd, "__self__"):
                    continue
                try:
                    if cmd.__self__.__class__.__name__ == instance.__class__.__name__:
                        del self_mods.commands[name]
                        for alias, _command in self_mods.aliases.copy().items():
                            if _command == name:
                                del self_mods.aliases[alias]
                except Exception:
                    continue

        mods_cls.unregister_commands = safe_unregister  # type: ignore[assignment]
        setattr(mods_cls, "_etg_safe_unreg", True)
    ...
    def _write_server_config(self, root: str, logs: typing.List[str]) -> None:
        ...
        cert_path = (self.config["tls_cert_path"] or "").strip()
        key_path = (self.config["tls_key_path"] or "").strip()
        if tls_enabled and (
            not cert_path
            or not key_path
            or not os.path.isfile(cert_path)
            or not os.path.isfile(key_path)
        ):
            logs.append("tls: cert/key missing, fallback to http")
            tls_enabled = False
            try:
    ...
    @staticmethod
    def _python_candidates() -> typing.List[str]:
        return [
            "python",
            "py",
            "python3",
    ...
    @staticmethod
    def _dedupe_list(items: typing.List[str]) -> typing.List[str]:
    ...
    def _find_python_exec(self) -> str:
        ...
        if os.path.isfile(venv_python):
            return venv_python
        for name in self._python_candidates():
            path = shutil.which(name)
            if path:
                return path
        return ""

    def _server_start_commands(
        self,
        server_path: str,
        python_cmds: typing.Optional[typing.List[str]] = None,
    ) -> typing.List[str]:
        ...
        if os.path.isfile(venv_python):
            commands.append(f'"{venv_python}" "{server_path}"')
        candidates = python_cmds or []
        if not candidates:
            for name in self._python_candidates():
                if shutil.which(name):
                    candidates.append(name)
        for name in self._dedupe_list(candidates):
            commands.append(f'{name} "{server_path}"')
        return self._dedupe_list(commands)

    def _python_inventory(self, logs: typing.List[str]) -> typing.List[str]:
        commands: typing.List[str] = []
        venv_python = os.path.normpath(
            os.path.join(utils.get_base_dir(), "..", "venv", "bin", "python")
        )
        if os.path.isfile(venv_python):
            code, out = self._exec_shell([venv_python, "-V"])
            ver = out or "unknown"
            logs.append(f"python: venv -> {ver}")
        for name in self._python_candidates():
            path = shutil.which(name)
            if not path:
                continue
            code, out = self._exec_shell([path, "-V"])
            ver = out or "unknown"
            logs.append(f"python: {name} -> {ver}")
            commands.append(name)
        return self._dedupe_list(commands)

    def _log_env(self, logs: typing.List[str]) -> None:
        for cmd in [
            "systemctl",
            "service",
            "rc-service",
            ...
            if shutil.which(cmd):
                logs.append(f"cmd: {cmd}: ok")
            else:
                logs.append(f"cmd: {cmd}: missing")
    @staticmethod
    def _add_terminal_cmds(lines: typing.List[str], commands: typing.List[str]) -> None:
        for cmd in commands:
            lines.append(f".terminal {cmd}")

    @staticmethod
    def _format_shell_line(cmd: typing.List[str], use_sudo: bool, sudo_ctx: dict) -> str:
        prefix = ""
        if use_sudo and sudo_ctx.get("use_sudo") and not sudo_ctx.get("is_root"):
            prefix = "sudo "
        return prefix + " ".join(cmd)

    def _run_cmd_attempt(
        self,
        cmd: typing.List[str],
        sudo_ctx: dict,
        logs: typing.List[str],
        ...
        attempted: typing.List[str] = []
        use_sudo_first = bool(sudo_ctx.get("use_sudo")) and not bool(sudo_ctx.get("is_root"))
        tries = [use_sudo_first, False]
        seen = set()
        for use_sudo in tries:
            if use_sudo in seen:
                continue
            seen.add(use_sudo)
            code, out = self._run_command(cmd, sudo_ctx, use_sudo, logs, label)
            attempted.append(self._format_shell_line(cmd, use_sudo, sudo_ctx))
            out_low = (out or "").lower()
            ok = code == 0
            logs.append(
                f"{label} ({'sudo' if use_sudo else 'nosudo'}): "
                f"{out if out else ('ok' if ok else 'failed')}"
            )
            if ok:
    ...
    def _run_cmd_sequence(
        ...
        attempted: typing.List[str] = []
        for cmd in commands:
            ok, tried = self._run_cmd_attempt(cmd, sudo_ctx, logs, label)
            attempted.extend(tried)
            if ok:
                return True, attempted
        return False, attempted

    def _ensure_etg_service(self, root: str, logs: typing.List[str]) -> bool:
        if self._is_windows():
            return False
        if not shutil.which("systemctl"):
            logs.append("systemd: unavailable")
            return False
        server_path = self._etg_server_path(root)
        if not os.path.isfile(server_path):
            logs.append(f"server script missing: {server_path}")
            return False
        venv_python = self._find_python_exec()
        if not venv_python:
            logs.append("systemd: python not found, skip systemd")
            return False
        service_text = (
            "[Unit]\n"
        ...
        if code != 0:
            logs.append(f"systemd: daemon-reload failed, skip ({out})")
            return False
        logs.append("systemd: daemon-reload ok")
        code, out = self._exec_shell(["systemctl", "enable", "--now", "etg-bridge.service"])
        if code != 0:
            logs.append(f"systemd: enable failed, skip ({out})")
            return False
        logs.append("systemd: enable ok")
        code, out = self._exec_shell(["systemctl", "restart", "etg-bridge.service"])
        if code != 0:
            logs.append(f"systemd: restart failed, skip ({out})")
            return False
        logs.append("systemd: restart ok")
        return True
    ...
    def _try_start_server_direct(
        self,
        root: str,
        logs: typing.List[str],
        python_cmds: typing.List[str],
    ) -> typing.Tuple[bool, typing.List[str]]:
        server_path = self._etg_server_path(root)
        if not os.path.isfile(server_path):
            logs.append(f"server script missing: {server_path}")
        ...
        if os.path.isfile(venv_python):
            commands.append([venv_python, server_path])
        for name in python_cmds:
            commands.append([name, server_path])
        attempted: typing.List[str] = []
        for cmd in commands:
            ...
            try:
                ...
                logs.append(f"server start failed: {exc}")
                continue
            time.sleep(1.5)
            if self._probe_health(self.config["listen_port"]):
                logs.append("server start: ok (direct)")
                return True, attempted
            try:
                proc.terminate()
            except Exception:
                pass
        logs.append("server start: failed (direct)")
        return False, attempted
    ...
    def _run_pkg_command(
        ...
        code, out = self._run_command(args, sudo_ctx, True, logs, label)
        if code == 0:
    ...
    def _install_ufw(
        ...
        installers: typing.List[typing.List[str]] = []
        if shutil.which("apt-get") or shutil.which("apt"):
            installers.append(["apt-get", "install", "-y", "ufw"])
            installers.append(["apt", "install", "-y", "ufw"])
        if shutil.which("dnf"):
            installers.append(["dnf", "-y", "install", "ufw"])
        if shutil.which("yum"):
            installers.append(["yum", "-y", "install", "ufw"])
        if shutil.which("pacman"):
            installers.append(["pacman", "-Sy", "--noconfirm", "ufw"])
        if shutil.which("zypper"):
            installers.append(["zypper", "--non-interactive", "install", "ufw"])
        if shutil.which("apk"):
            installers.append(["apk", "add", "--no-cache", "ufw"])

        if not installers:
            logs.append("ufw: no supported package manager found")
            return False, []

        ok, attempted = self._run_cmd_sequence(installers, sudo_ctx, logs, "ufw install")
        if ok and shutil.which("ufw"):
    ...
    def _disable_iptables(
        ...
        if shutil.which("rc-service"):
            commands.extend(
                [
                    ...
                    ["rc-service", "netfilter-persistent", "stop"],
                ]
            )
        ...
        if shutil.which("killall"):
            commands.append(["killall", "iptables"])

        if not commands:
            logs.append("iptables: no supported commands")
            return False, []

        ok, attempted = self._run_cmd_sequence(commands, sudo_ctx, logs, "iptables")
        return ok, attempted
    ...
    def _ufw_allow_port(
        ...
        commands: typing.List[typing.List[str]] = []
        if shutil.which("ufw"):
            commands.append(["ufw", "allow", str(port)])
        if shutil.which("firewall-cmd"):
            commands.append(
                ["sh", "-c", f"firewall-cmd --permanent --add-port={port}/tcp && firewall-cmd --reload"]
            )
        ...
        if not commands:
            logs.append("port open: no supported commands")
            return False, []

        ok, attempted = self._run_cmd_sequence(commands, sudo_ctx, logs, "open port")
        return ok, attempted
    ...
    @staticmethod
    def _apply_prefix(commands: typing.List[str], prefix: str) -> typing.List[str]:
        if not prefix:
            return commands
        return [f"{prefix}{cmd}" for cmd in commands]

    def _iptables_disable_commands(self, sudo_prefix: str) -> typing.List[str]:
        base_cmds = [
            "systemctl stop iptables",
            "systemctl disable iptables",
            "service iptables stop",
        ...
        return self._dedupe_list(self._apply_prefix(base_cmds, sudo_prefix))

    def _ufw_install_commands_all(self, sudo_prefix: str) -> typing.List[str]:
        base_cmds = [
    ...
    def _open_port_commands_all(self, port: int, sudo_prefix: str) -> typing.List[str]:
        base_cmds = [
            f"ufw allow {port}",
            f"firewall-cmd --permanent --add-port={port}/tcp && firewall-cmd --reload",
            f"iptables -I INPUT -p tcp --dport {port} -j ACCEPT",
            f"nft add rule inet filter input tcp dport {port} accept",
        ]
        return self._dedupe_list(self._apply_prefix(base_cmds, sudo_prefix))
    ...
    def _build_post_install_message(
        ...
        return self._t(lang, "post_ok_title")
    ...
    def _health_curl_line(self, scheme: str, host: str, port: int) -> str:
        if scheme == "https":
    ...
    def _build_manual_steps(
        ...
        iptables_cmds = attempts.get("iptables") or []
        ufw_install_cmds = attempts.get("ufw_install") or []
        open_port_cmds = attempts.get("open_port") or []
        server_cmds = attempts.get("server_start") or []

        if iptables_cmds:
            lines.append(self._t(lang, "manual_step_iptables"))
            self._add_terminal_cmds(lines, iptables_cmds)

        if ufw_install_cmds:
            lines.append(self._t(lang, "manual_step_ufw_install"))
            self._add_terminal_cmds(lines, ufw_install_cmds)

        if open_port_cmds:
            lines.append(self._t(lang, "manual_step_ufw_allow", port=port))
            self._add_terminal_cmds(lines, open_port_cmds)

        if server_cmds:
            lines.append(self._t(lang, "manual_step_server"))
            self._add_terminal_cmds(lines, server_cmds)

        lines.append(self._t(lang, "manual_step_check"))
        external_ip = status.get("external_ip") or ""
        local_ip = status.get("local_ip") or ""
        check_cmds: typing.List[str] = []
        if has_public:
            if external_ip:
                check_cmds.append(self._health_curl_line(scheme, external_ip, port))
        else:
            if local_ip:
                check_cmds.append(self._health_curl_line(scheme, local_ip, port))
        self._add_terminal_cmds(lines, check_cmds)
    ...
    def _allow_ports(self, ports: typing.List[int], logs: typing.List[str]) -> None:
        for port in ports:
            self._ufw_allow_port(port, logs, self._get_sudo_ctx())
    ...
    def _run_install(
        ...
        self._log_env(logs)
        python_cmds = self._python_inventory(logs)
        self._ensure_server_script(root, logs)
        self._write_server_config(root, logs)
        service_ok = self._ensure_etg_service(root, logs)

        copied = self._copy_etg_files(logs)
        iptables_ok, iptables_attempts = self._disable_iptables(logs, sudo_ctx)
        ufw_install_ok, ufw_install_attempts = (True, [])
        if not shutil.which("ufw"):
            ufw_install_ok, ufw_install_attempts = self._install_ufw(logs, sudo_ctx)
        open_ok, open_attempts = self._ufw_allow_port(
            int(self.config["listen_port"]), logs, sudo_ctx
        )
        server_attempts: typing.List[str] = []
        if not service_ok:
            direct_ok, server_attempts = self._try_start_server_direct(
                root, logs, python_cmds
            )
            service_ok = service_ok or direct_ok
        ...
        status = {
            ...
            "local_ip": local_ip,
            "attempts": {
                "iptables": iptables_attempts,
                "ufw_install": ufw_install_attempts,
                "open_port": open_attempts,
                "server_start": server_attempts,
            },
            "python_cmds": python_cmds,
            "service_ok": service_ok,
            "ufw_install_ok": ufw_install_ok,
        }
    ...
    async def _perform_install(
        ...
        try:
            _log_lines, etg_file, mandre_file, status = await asyncio.to_thread(
                self._run_install, port, sudo_ctx, has_public
            )
        except Exception as exc:
        ...
        if not ok:
            manual_text = self._build_manual_steps(
                port, lang, status, scheme, sudo_ctx, has_public
            )
    ...
    @loader.command(ru_doc="УСТАНОВКА ЛИБЫ", en_doc="УСТАНОВКА ЛИБЫ")
